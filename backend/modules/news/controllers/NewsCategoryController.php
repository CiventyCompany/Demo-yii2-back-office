 ...
 */
class NewsCategoryController extends \common\modules\news\controllers\NewsCategoryController
{
    /**
     * @inheritdoc
     */
    ...
    public function actionIndex()
    {
        ...
        $dataProvider = $searchModel->search(Yii::$app->request->get('NewsCategorySearch'));
