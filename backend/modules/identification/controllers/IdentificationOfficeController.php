...
use backend\modules\identification\models\search\IdentificationOfficeSearch;
use common\modules\identification\models\IdentificationMethod;
use backend\modules\identification\models\IdentificationOffice;
use Yii;
 ...
 */
class IdentificationOfficeController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new IdentificationOfficeSearch();
    ...
    {
        $model = new IdentificationOffice();
    ...
    {
        if (($model = IdentificationOffice::findOne($id)) !== null) {
            return $model;
        } else {
