    ...
    'columns' => [
        ...
        [
            ...
            'value' => function($model){
               return isset($model->profile) ? "<a href='/user/registered/view?id=".$model->id."' data-pjax='0'>".$model->profile->getFullName()."</a>" : null;
            }
        ],
        [
            'attribute' => 'email',
        ...
        [
            ...
            'buttons'=>[
                'view' => function ($url, $model) {
                    $customurl = Yii::$app->getUrlManager()->createUrl(['user/registered/view', 'id' => $model->id]);
                    return \yii\helpers\Html::a( '<span class="glyphicon glyphicon-eye-open"></span>', $customurl,
                        ['title' => Yii::t('yii', 'View'), 'data-pjax' => '0']);
                },
                'block'=>function ($url, $model) {
                    $customurl = Yii::$app->getUrlManager()->createUrl(['user/registered/block', 'id' => $model->id]);
                    return \yii\helpers\Html::a( '<span class="glyphicon glyphicon-remove-sign"></span>', $customurl,
                        ['title' => Yii::t('app', 'Block'), 'data-pjax' => '0']);
                },
