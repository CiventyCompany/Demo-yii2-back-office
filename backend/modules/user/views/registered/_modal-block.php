    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><?= Yii::t('app','Enter reason for blocking user: ').'<br>'.Profile::getUserFullName($userId); ?></h4>
            </div>
            <div class="modal-body">
                <?php $form = ActiveForm::begin(['action' => '/user/ajax/blocked-user', 'id' => 'blockForm', 'options' => ['class'=>'modalForm']]); ?>
            ...
            <div class="modal-footer">
                <?= \yii\helpers\Html::submitButton(Yii::t('app', 'Block user'),['form' => 'blockForm', 'class'=> 'btn btn-danger']); ?>
