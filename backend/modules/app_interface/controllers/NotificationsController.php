...
use backend\modules\app_interface\models\NotificationsSearch;
...
class NotificationsController extends Controller
{
    ...
    /**
     * Mark notification as read, by record-id
     */
    public function actionMarkAsRead()
    {
        $id = Yii::$app->request->get('id');
        $model = Notifications::findOne(['notification_id' => $id]);
        $model->mark = Notifications::MARK_AS_READ;
        $model->update();
    }
